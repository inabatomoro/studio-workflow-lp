      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 md:px-8 pt-10 pb-20 md:pt-14 md:pb-28">
        ...
        >
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <MagneticButton>
                <a href="#pricing" className="relative group inline-block text-center px-10 py-4 text-base font-bold rounded-2xl bg-gradient-to-r from-[var(--accent-color)] to-[#FDE08B] text-black shadow-[0_0_40px_rgba(212,175,55,0.4)] hover:shadow-[0_0_60px_rgba(212,175,55,0.6)] transition-all duration-300">
