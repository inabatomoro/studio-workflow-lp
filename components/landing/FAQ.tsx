...
const faqs = [
  {
    q: "全くの初心者でも大丈夫ですか？",
    a: "はい。ただし、本講座では基本操作の解説はあえて省き、実務フローへ特化しています。Studioの最低限の操作ができる方を対象としております。",
  },
  {
    q: "わからないところがあったら質問できますか？",
    a: "はい！特典として「2ヶ月間の質問用コミュニティ」が付帯します。講師や同期のクリエイターに即座に質問可能です。",
  },
  {
    q: "サポートは2ヶ月で本当に終わるのですか？",
    a: "はい。期限内で確実に実務レベルまで引き上げるための集中期間としており、自動課金への移行などは一切ありません。安心してご参加ください。",
  },
  {
    q: "購入後、どのくらいの期間アクセスできますか？",
