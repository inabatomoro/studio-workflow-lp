          ...
          <div className="relative group">
            ...
            <div className="relative glass-card-dark rounded-3xl p-8 md:p-12">
              ...
              <MagneticButton className="w-full">
                <a href={SALE_CONFIG.checkoutUrl} target="_blank" rel="noopener noreferrer" className="block text-center w-full py-5 text-lg font-black rounded-2xl bg-gradient-to-r from-[var(--accent-color)] to-[#e8d066] text-[var(--navy)] shadow-[0_0_30px_rgba(212,175,55,0.3)] hover:shadow-[0_0_50px_rgba(212,175,55,0.5)] transition-all duration-500">
